...
public class Ip_Finder_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(view -> {
            ...
            RequestQueue requestQueue= Volley.newRequestQueue(Ip_Finder_Activity.this);
            ...
            StringRequest request=new StringRequest(Request.Method.GET, url, response -> {
                try{
                    ...
                    infoList.forEach(text -> {
                        TextView toAdd = new TextView(Ip_Finder_Activity.this);
                        toAdd.setText(text);
                    ...
                    Button MapBtn=new Button(Ip_Finder_Activity.this);
                    ...
                    MapBtn.setOnClickListener(view1 -> {
                        Intent Map=new Intent(view.getContext(),Maps_Activity.class);
